...
<script>
    ...
    $('.pluginAction[data-action=uploadAPIKey]').on('click', function () {
        $(this).fileupload({
            ...
            url: 'plugins/tvremote/core/ajax/tvremote.ajax.php?action=uploadAPIKey',
            dataType: 'json',
    ...
    $('.pluginAction[data-action=uploadCustomSound]').on('click', function () {
        $(this).fileupload({
            replaceFileInput: false,
            url: 'plugins/tvremote/core/ajax/tvremote.ajax.php?action=uploadCustomSound',
            dataType: 'json',
            done: function (e, data) {
                if (data.result.state != 'ok') {
                    $('#div_alert').showAlert({ message: data.result.result, level: 'danger' });
    ...
    $('.pluginAction[data-action=uploadCustomRadios]').on('click', function () {
        $(this).fileupload({
            replaceFileInput: false,
            url: 'plugins/tvremote/core/ajax/tvremote.ajax.php?action=uploadCustomRadios',
            dataType: 'json',
            done: function (e, data) {
                if (data.result.state != 'ok') {
                    $('#div_alert').showAlert({ message: data.result.result, level: 'danger' });
    ...
    $('.customclass-updateradios').on('click', function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#div_alert').showAlert({
                    message: '{{Demande de mise à jour des listes :: Radios :: envoyée (voir les logs tvremote)}}',
                    level: 'success'
                });
            }
        });
    ...
    $('.customclass-updatecustomradios').on('click', function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#div_alert').showAlert({
                    message: '{{Demande de mise à jour des listes :: CustomRadios :: envoyée (voir les logs tvremote)}}',
                    level: 'success'
                });
            }
        });
    ...
    $('.customclass-updatesounds').on('click', function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#div_alert').showAlert({
                    message: '{{Demande de mise à jour des listes :: Sounds :: envoyée (voir les logs tvremote)}}',
                    level: 'success'
                });
            }
        });
    ...
    $('.customclass-updatecustomsounds').on('click', function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#div_alert').showAlert({
                    message: '{{Demande de mise à jour des listes :: Custom Sounds :: envoyée (voir les logs tvremote)}}',
                    level: 'success'
                });
            }
        });
